    ...
    <div className="bg-indigo-50/50 border border-indigo-100 rounded-2xl p-6 flex items-start gap-4">
      ...
      <div>
        ...
        <p className="text-xs text-indigo-700/80 mt-1 font-medium leading-relaxed">
          These are priority keywords calculated by merging search traffic, cost per click, and competitors' gaps. Target **Quick Wins** first to capture high volume with low ranking difficulty, and secure **Protect Brand** terms to block competitors from bid-hijacking your brand name.
        </p>
      </div>
    </div>
      ...
      >
        ...
        <div className="flex items-center gap-6 ml-4 flex-shrink-0 flex-wrap justify-end">
          ...
          <div className="text-right">
            <p className="text-[8px] font-black uppercase tracking-widest text-gray-400">Difficulty</p>
            <p className={cn('text-sm font-black text-gray-900', difficultyLabel(rec.difficulty).color)}>
              {rec.difficulty}
            </p>
            <div className="w-16 h-1 mt-1 bg-gray-100 rounded-full overflow-hidden ml-auto">
              <div
                className={cn(
                  'h-full rounded-full',
          ...
          {results.map((result, index) => {
            ...
            return (
              <div
                ...
                className={cn(
                  "group relative bg-white rounded-2xl border transition-all duration-300 flex flex-col justify-between overflow-hidden shadow-sm hover:shadow-md hover:-translate-y-0.5",
                  isTwin 
