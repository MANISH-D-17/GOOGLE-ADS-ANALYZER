...
try:
    ...
    tasks_ready = client.get('/v3/on_page/lighthouse/tasks_ready')
        ...
        for task in tasks_ready['tasks']:
            if 'result' in task and task['result']:
                for task_ready in task['result']:
                    ...
                    # GET /v3/on_page/lighthouse/task_get/json
                    ...
                    """
                    if 'id' in task_ready:
                        result.append(client.get('/v3/on_page/lighthouse/task_get/json/' + task_ready['id']))
                    """
    print(result)
