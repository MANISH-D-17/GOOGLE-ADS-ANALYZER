        ...
        for task in tasks_ready['tasks']:
            if 'result' in task and task['result']:
                for task_ready in task['result']:
                    ...
                    # GET /v3/serp/google/organic/task_get/regular
                    if 'endpoint_regular' in task_ready:
                        result.append(client.get(task_ready['endpoint_regular']))
                    
                    # #3 - another way to get the task results by id
                    # GET /v3/serp/google/organic/task_get/regular
                    """
                    if 'id' in task_ready:
                        result.append(client.get('/v3/serp/google/organic/task_get/regular/' + task_ready['id']))
                    """
    print(result)
