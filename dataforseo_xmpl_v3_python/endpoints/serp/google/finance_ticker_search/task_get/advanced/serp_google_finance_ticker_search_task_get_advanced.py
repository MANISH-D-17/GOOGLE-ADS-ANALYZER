        ...
        for task in tasks_ready['tasks']:
            if 'result' in task and task['result']:
                for task_ready in task['result']:
                    ...
                    # GET /v3/serp/google/finance_ticker_search/task_get/advanced
                    ...
                    """
                    if 'id' in task_ready:
                        result.append(client.get('/v3/serp/google/finance_ticker_search/task_get/advanced/' + task_ready['id']))
                    """
    print(result)
