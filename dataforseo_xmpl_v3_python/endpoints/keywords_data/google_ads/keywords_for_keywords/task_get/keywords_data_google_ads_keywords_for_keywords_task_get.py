        ...
        for task in tasks_ready['tasks']:
            if 'result' in task and task['result']:
                for task_ready in task['result']:
                    ...
                    # GET /v3/keywords_data/google_ads/keywords_for_keywords/task_get
                    ...
                    """
                    if 'id' in task_ready:
                        result.append(client.get('/v3/keywords_data/google_ads/keywords_for_keywords/task_get/' + task_ready['id']))
                    """
    print(result)
