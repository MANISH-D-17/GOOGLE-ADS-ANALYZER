        ...
        for task in tasks_ready['tasks']:
            if 'result' in task and task['result']:
                for task_ready in task['result']:
                    ...
                    # GET /v3/business_data/google/questions_and_answers/task_get
                    ...
                    """
                    if 'id' in task_ready:
                        result.append(client.get('/v3/business_data/google/questions_and_answers/task_get/' + task_ready['id']))
                    """
    print(result)
