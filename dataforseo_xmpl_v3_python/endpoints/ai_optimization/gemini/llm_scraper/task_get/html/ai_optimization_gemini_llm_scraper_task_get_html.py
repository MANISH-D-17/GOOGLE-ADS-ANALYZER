...
try:
    ...
    tasks_ready = client.get('/v3/ai_optimization/gemini/llm_scraper/tasks_ready')
        ...
        for task in tasks_ready['tasks']:
            if 'result' in task and task['result']:
                for task_ready in task['result']:
                    ...
                    # GET /v3/ai_optimization/gemini/llm_scraper/task_get/html
                    if 'endpoint_html' in task_ready:
                        result.append(client.get(task_ready['endpoint_html']))
                    
                    # #3 - another way to get the task results by id
                    # GET /v3/ai_optimization/gemini/llm_scraper/task_get/html
                    """
                    if 'id' in task_ready:
                        result.append(client.get('/v3/ai_optimization/gemini/llm_scraper/task_get/html/' + task_ready['id']))
                    """
    print(result)
