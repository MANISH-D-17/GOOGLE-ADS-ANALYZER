        ...
        for task in tasks_ready['tasks']:
            if 'result' in task and task['result']:
                for task_ready in task['result']:
                    ...
                    # GET /v3/ai_optimization/chat_gpt/llm_scraper/task_get/advanced
                    ...
                    """
                    if 'id' in task_ready:
                        result.append(client.get('/v3/ai_optimization/chat_gpt/llm_scraper/task_get/advanced/' + task_ready['id']))
                    """
    print(result)
