...
import { Target, TrendingUp, AlertCircle, CheckCircle, Radio } from 'lucide-react';
...
export const CampaignDashboard: React.FC<{ dateRange: string }> = ({ dateRange }) => {
  ...
  if (isLoading) return <PageLoader icon={<Radio />} gradient="from-indigo-600 to-violet-600" color="indigo" label="Loading campaign data…" />;
