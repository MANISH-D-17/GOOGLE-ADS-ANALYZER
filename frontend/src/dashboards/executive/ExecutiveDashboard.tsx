...
import { DollarSign, MousePointerClick, Eye, ShoppingCart, Percent, TrendingUp } from 'lucide-react';
...
export const ExecutiveDashboard: React.FC<{ dateRange: string }> = ({ dateRange }) => {
  ...
  if (isLoading) return <PageLoader icon={<TrendingUp />} gradient="from-indigo-600 to-violet-600" color="indigo" label="Loading executive overview…" />;
